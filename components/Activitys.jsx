...
export default function ActivityGallery () {
  return (
    <div className="flex w-full flex-wrap gap-4 justify-center text-white">
      ...
      <article className="text-center relative">
        <div className="tumbnail border-2 border-fuchsia-300 p-2 rounded-md">
          <Image className="m-auto rounded-md" src="/conciertos.jpg" priority width={320} height={320} alt="juegos militares rapjuve" />
        </div>
      ...
      <article className="text-center relative">
        <div className="tumbnail border-2 border-fuchsia-300 p-2 rounded-md">
          <Image className="m-auto rounded-md" src="/carreras5k.jpg" priority width={320} height={320} alt="juegos militares rapjuve" />
        </div>
      ...
      <article className="text-center relative">
        <div className="tumbnail border-2 border-fuchsia-300 p-2 rounded-md">
          <Image className="m-auto rounded-md" src="/campos-tematicos.jpg" priority width={320} height={320} alt="juegos militares rapjuve" />
        </div>
      ...
      <article className="text-center relative">
        <div className="tumbnail border-2 border-fuchsia-300 p-2 rounded-md">
          <Image className="m-auto rounded-md" src="/plenarias.jpg" priority width={320} height={320} alt="juegos militares rapjuve" />
        </div>
      ...
      <article className="text-center relative">
        <div className="tumbnail border-2 border-fuchsia-300 p-2 rounded-md">
          <Image className="m-auto rounded-md" src="/noches-de-talentos.jpg" priority width={320} height={320} alt="juegos militares rapjuve" />
        </div>
